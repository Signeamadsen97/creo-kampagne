...
<template>
  <main>
    ...
    <section id="about_project">
      <TwoColumnGrid>
        <template #col-1>
          <TextMedia heading="OUH i dag og for fremtiden" grid-heading="Området midt i Odense skal have nyt liv"
            grid-text-top="I dag er OUH fyns største arbejdsplads, men om nogen år, når hospitalet flytter adresse, bliver mulighederne er mange. Området skal genanvendes og blive til noget nyt. <br/> <br/>
            Der er bygget over mange år, i den byggestilen som har passet til tiden. Derfor står der mange forskellige bygningskroppe på området, fra forskellige tider og stilarter. Alle bygningerne har forskellige potentialer for genanvendelse efter hospitalets udrykning."
            :grid-image-src="boligblokImage" />
        </template>
        <template #col-2>
          <TextMedia heading="" grid-heading="Drømme for fremtiden" grid-text-top="
            Vi har mange ideer og drømme for området, både nye ideer og ideer som bevare nogen af områdets skjulte skatte og de smukke originale bygningsværker. Samtidig tror vi på at byens borgere skal have mulighed for at give deres ideer til hvad der skal ske på det nye byområde. <br/>
            Derfor vil vi give muligheden for at i allerede nu kan komme med jeres ideer og drømme. <br/> <br/>
            Drømmer du om skønne boliger, Grønne områder, sociale samlings steder eller noget helt andet, i dit nærområde? <br/>
            Så er det nu og her du kan få muligheden for at få netop dine drømme inkluderet i udviklingen."
